 ...
 * The following situation is assumed:  <code><pre>
 *
 *     (0, 0) o------------------>x-axis
 *            | .  / direction
 *            |  .
 ...
 *          y-axis
 *
 * </pre></code> The direction of the vector is defined as the angle (0..2*pi)
 * of the vector direction clockwise with reference to the x-coordinate
 * direction.
 *
 * Created 26.03.2016
 *
...
public class Vector2D implements Serializable
{
    ...
    /**
     * Returns the square of the magnitude, without squareroot calculation. This
     * is useful when performance is an issue.
     *
    ...
    /**
     * Returns a new vector with magnitude 1 in the direction of the given
     * vector.
     *
    ...
    /**
     * Rotates the vector by the specified angle at the position specified by
     * the given Vector2D.
     *
     * @param angle the rotation angle (in radian, clockwise)
    ...
    /**
     * Returns the scalar product (dot product) of the current vector with the
     * given vector.
     *
    ...
    /**
     * Returns a new vector that is the vector sum of the current vector and the
     * given vector. Be aware that the current vector is not modified.
     *
    ...
    /**
     * Returns a new vector with inverted coordinates. Be aware that the current
    ...
    /**
     * Returns a new vector that is the vector difference of the current vector
     * and the given vector. Be aware that the current vector is not modified.
     *
    ...
    /**
     * Returns a new vector that is the product by a scalar of the current
     * vector and the given integer. Be aware that the current vector is not
     * modified.
     *
    ...
    /**
     * Returns a new vector that is the product by a scalar of the current
     * vector and the given float. Be aware that the current vector is not
     * modified.
     *
    ...
    /**
     * Returns a new vector that is the product by a scalar of the current
     * vector and the given double. Be aware that the current vector is not
     * modified.
     *
